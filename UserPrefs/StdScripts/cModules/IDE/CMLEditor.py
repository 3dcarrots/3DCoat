...
# Globals
logger = _logging.getLogger("CMLEditor.py")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        sshFile=os.fspath(os.path.dirname(os.path.realpath(__file__)) + "/CMLEditorUI.css")
        ...
        if len(sys.argv) > 2:
            ...
            self.setWindowTitle('CML Editor')
        ...
        #htmlFileName = os.fspath(os.path.dirname(os.path.realpath(__file__)) + "/temp.html")
        htmlFileName = os.fspath(os.path.dirname(os.path.realpath(__file__)) + "/CMLEditor.html")
        ...
        ## HotKeys
        hotkeysFileName = os.fspath(os.path.dirname(os.path.realpath(__file__)) + "/hotkeys.html")
        ...
        ## Documentation
        #docFileName = os.fspath(os.path.dirname(os.path.realpath(__file__)) + "/glslDoc/index.html")
        docFileName = os.fspath(os.path.dirname(os.path.realpath(__file__)) + "/docs.html")
    ...
    def SaveCML(self, html):
        #f = open(os.path.dirname(os.path.realpath(__file__))+"/tmp.cml", "w")
        #f.write(html)
        #f.close()
    ...
    def ShowCMLHelp(self, aWord):
        if os.path.exists(os.path.dirname(os.path.realpath(__file__))+"/glslDoc/"+aWord+".html"):
