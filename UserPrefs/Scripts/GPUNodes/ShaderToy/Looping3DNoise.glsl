// https://www.shadertoy.com/view/tlGfzG
//
...
void mainImage( out vec4 fragColor, in vec3 fragCoord(knot = Projection))
{
    ...
    float n = loopNoise3d(uv.xy * noiseScale,uv.z * noiseScale, loopDuration, speed);

    //travelling noise
    //float n = loopNoise3d(uv * noiseScale + iTime,0., loopDuration, speed);
